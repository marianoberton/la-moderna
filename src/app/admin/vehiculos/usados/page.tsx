  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold tracking-tight">Vehículos Usados</h1>
        <Button asChild>
          <Link href="/admin/vehiculos/agregar?condicion=USADO">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Listado de Vehículos Usados</CardTitle>
          <CardDescription>
            Gestiona todos los vehículos usados disponibles en tu inventario
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
              ...
              <TableBody>
                {vehicles.map((vehicle) => (
                  <TableRow key={vehicle.id}>
                    ...
                    <TableCell>{vehicle.kilometraje.toLocaleString('es-AR')} km</TableCell>
                    <TableCell>
                ...
                {vehicles.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={8} className="text-center py-8 text-muted-foreground">
                      No hay vehículos usados disponibles
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
        ...
        <CardFooter>
          <div className="text-sm text-muted-foreground">
            Total: {vehicles.length} vehículos usados
          </div>
        </CardFooter>
      </Card>
    </div>
