...
import { ArrowRight, BadgeDollarSign, RefreshCw, ThumbsUp, DollarSign, Truck, ShieldCheck } from 'lucide-react';
...
export default function CtaExchange() {
  ...
  const [activeTab, setActiveTab] = useState<'cambio' | 'consigna'>('cambio');
  ...
  const openWhatsApp = (whatsapp: string, service: 'cambio' | 'consigna' = 'cambio') => {
    let message = "";
    
    if (service === 'cambio') {
      message = encodeURIComponent("Hola, me gustaría cotizar mi vehículo para un posible cambio por uno nuevo.");
    } else {
      message = encodeURIComponent("Hola, me gustaría obtener información sobre el servicio de consigna de vehículos.");
    }
                ...
                <>
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    >
                      ...
                      {/* Menú desplegable de concesionarias */}
                      <AnimatePresence>
                        {showConcesionarias && (
                          <motion.div
                              ...
                              <div className="space-y-3">
                                {concesionarias.map((concesionaria) => (
                                  <button
                                    ...
                                    onClick={() => openWhatsApp(concesionaria.whatsapp, 'cambio')}
                                  >
                ...
                <>
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    <div>
                      ...
                      >
                        Consigná tu vehículo
                        <span className="block mt-1">y vendelo con nosotros</span>
                      </motion.h2>
                      ...
                      <motion.p 
                        ...
                        viewport={{ once: true }}
                      >
                        Dejá tu vehículo en nuestras manos y nosotros nos encargamos de todo. Lo exhibimos limpio y cuidado, nos ocupamos de las gestiones y vos solo esperás el pago.
                      </motion.p>
                    </div>
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-medium text-white uppercase text-sm tracking-wide">Mejor valor de mercado</h4>
                          <p className="text-sm text-gray-300">Obtenemos el precio justo por tu vehículo</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-medium text-white uppercase text-sm tracking-wide">Exhibición profesional</h4>
                          <p className="text-sm text-gray-300">Mantenemos tu auto limpio y en perfectas condiciones</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-medium text-white uppercase text-sm tracking-wide">Respaldo y confianza</h4>
                          <p className="text-sm text-gray-300">Toda la gestión en un solo lugar</p>
                        </div>
                      </div>
                    </motion.div>
                              ...
                              <div className="space-y-3">
                                {concesionarias.map((concesionaria) => (
                                  <button
                                    key={concesionaria.id}
                                    className="w-full text-left p-3 hover:bg-neutral-700 rounded-md flex items-center text-sm transition-colors"
                                    onClick={() => openWhatsApp(concesionaria.whatsapp, 'consigna')}
                                  >
                                    <div className="h-10 w-10 rounded-full flex items-center justify-center bg-neutral-700 mr-3 flex-shrink-0">
                                      <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    >
                      <img 
                        src="/images/exchange-car.jpg"
                        alt="Servicio de consigna de vehículos" 
                        className="w-full h-full object-cover"
                        style={{ maxHeight: '400px' }}
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
